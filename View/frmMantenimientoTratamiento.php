...
<html lang="en">
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-2" style="background-color:lavender;">ID TRATAMIENTO</div>
			<div class="col-sm-2" style="background-color:lavenderblush;">ID MEDICACION</div>
			<div class="col-sm-3" style="background-color:lavender;">TRATAMIENTO</div>
...
if (!$vlConexion) {
	...
	$vlQuerySelect = "SELECT * FROM Tratamiento";
	...
	if (mysqli_num_rows($vlEjecucion)>0) {
		...
		?>
				<form method="POST" action="frmEditarTratamiento.php">
					<div class="col-sm-2" style="background-color:lavender;"><?php echo $vlRegistro['ID_Tratamiento']; ?></div>
					<input type="hidden" name="txtId" value=<?php echo $vlRegistro['ID_Tratamiento']; ?>>
					<div class="col-sm-2" style="background-color:lavenderblush;"><?php echo $vlRegistro['ID_Medicacion']; ?></div>
					<div class="col-sm-3" style="background-color:lavender;"><?php echo $vlRegistro['Tratamiento']; ?></div>
