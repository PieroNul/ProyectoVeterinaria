...
<body>
	<div class="container">
		<h2 style="color:white">BUSQUEDA DE HISTORIALES ANTIGUOS</h2>
			<div class="form-group">
				<form method="POST" action="frmHistorialEliminadas.php">
					<div class="form-group">
						<label for="txtNombre" style="color:white;">INGRESAR NOMBRE DE LA MASCOTA</label>
				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-sm-2" style="background-color:lavender;">ID VISITA</div>
		...
		if (!$vlConexion) {
			...
			$vlQuerySelect = "SELECT V.ID_Visita,M.NombreMascota,D.nombre,T.Tratamiento,V.TipoDeVisita,V.FechaVisita FROM Visitas V
...
WHERE Estado = 0 and  M.NombreMascota like '%".$vlNombre."%';";
			...
			if (mysqli_num_rows($vlEjecucion)>0) {
				...
				?>
						...
						<div class="col-sm-2" style="background-color:lavender;"><?php echo $vlRegistro['nombre']; ?></div>
