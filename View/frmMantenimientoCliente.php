...
<html lang="en">
	...
	<div class="container-fluid">
		<form method="POST" action="frmNuevoCliente.php">
			<button type="submit" class="Piero"><span class="Piero2"></span>AGREGAR CLIENTE</button>
		</form>
		<div class="row">
			</br>
			<div class="col-sm-1" style="background-color:lavender;">ID CLIENTE</div>
			<div class="col-sm-2" style="background-color:lavenderblush;">NOMBRES</div>
			<div class="col-sm-2" style="background-color:lavender;">APELLIDOS</div>
			<div class="col-sm-2" style="background-color:lavenderblush;">DIRECCION</div>
			<div class="col-sm-1" style="background-color:lavender;">CIUDAD</div>
			<div class="col-sm-2" style="background-color:lavenderblush;">CODIGO POSTAL</div>
			<div class="col-sm-1" style="background-color:lavender;">TELEFONO</div>
			<div class="text-center" style="background-color:lavenderblush;">EDITAR</div>
<?php  
...
if (!$vlConexion) {
	...
	$vlQuerySelect = "SELECT * FROM Cliente";
	...
	if (mysqli_num_rows($vlEjecucion)>0) {
		...
		?>
				<form method="POST" action="frmEditarCliente.php">
					<div class="col-sm-1" style="background-color:lavender;"><?php echo $vlRegistro['ID_Cliente']; ?></div>
					<input type="hidden" name="txtId" value=<?php echo $vlRegistro['ID_Cliente']; ?>>
					<div class="col-sm-2" style="background-color:lavenderblush;"><?php echo $vlRegistro['Nombres']; ?></div>
					<div class="col-sm-2" style="background-color:lavender;"><?php echo $vlRegistro['Apellidos']; ?></div>
                    <div class="col-sm-2" style="background-color:lavenderblush;"><?php echo $vlRegistro['Direccion']; ?></div>
                    <div class="col-sm-1" style="background-color:lavender;"><?php echo $vlRegistro['Ciudad']; ?></div>
                    <div class="col-sm-2" style="background-color:lavenderblush;"><?php echo $vlRegistro['CodigoPostal']; ?></div>
                    <div class="col-sm-1" style="background-color:lavender;"><?php echo $vlRegistro['Telefono']; ?></div>
					<div class="text-center" style="background-color:lavenderblush;"><button type="submit" class="btn btn-primary">EDITAR</button></div><div class="col" style="background-color:lavenderblush;">.</div>
				</form>
			</div>
		</div>		
		<?php
