...
<html lang="en">
	...
	<div class="container-fluid">
		<form method="POST" action="frmNuevoMedicamento.php">
			<button type="submit" class="Piero"><span class="Piero2"></span>AGREGAR MEDICACION</button>
		</form>
		<div class="row">
			</br>
			<div class="col-sm-2" style="background-color:lavender;">ID MEDICACION</div>
			<div class="col-sm-3" style="background-color:lavenderblush;">MEDICACION</div>
			<div class="col-sm-3" style="background-color:lavender;">DESCRIPCION</div>
			<div class="col-sm-2" style="background-color:lavenderblush;">PRECIO</div>
...
if (!$vlConexion) {
	...
	$vlQuerySelect = "SELECT * FROM Medicacion";
	...
	if (mysqli_num_rows($vlEjecucion)>0) {
		...
		?>
				<form method="POST" action="frmEditarMedicacion.php">
					<div class="col-sm-2" style="background-color:lavender;"><?php echo $vlRegistro['ID_Medicacion']; ?></div>
					<input type="hidden" name="txtId" value=<?php echo $vlRegistro['ID_Medicacion']; ?>>
					<div class="col-sm-3" style="background-color:lavenderblush;"><?php echo $vlRegistro['Medicacion']; ?></div>
					<div class="col-sm-3" style="background-color:lavender;"><?php echo $vlRegistro['decripcion']; ?></div>
					<div class="col-sm-2" style="background-color:lavenderblush;"><?php echo $vlRegistro['Precio']; ?></div>
