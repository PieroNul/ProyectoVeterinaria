...
<html lang="en">
	...
	<div class="container-fluid">
		<form method="POST" action="frmNuevoDoctor.php">
			<button type="submit" class="Piero"><span class="Piero2"></span>AGREGAR DOCTOR</button>
		</form>
		<div class="row">
			</br>
			<div class="col-sm-1" style="background-color:lavender;">ID DOCTOR</div>
			<div class="col-sm-2" style="background-color:lavenderblush;">NOMBRE</div>
			<div class="col-sm-2" style="background-color:lavender;">APELLIDO</div>
			<div class="col-sm-1" style="background-color:lavenderblush;">TELEFONO</div>
			<div class="col-sm-2" style="background-color:lavender;">DIRECCION</div>
			<div class="col-sm-2" style="background-color:lavenderblush;">CORREO</div>
...
if (!$vlConexion) {
	...
	$vlQuerySelect = "SELECT * FROM Doctor";
	...
	if (mysqli_num_rows($vlEjecucion)>0) {
		...
		?>
				<form method="POST" action="frmEditarDoctor.php">
					<div class="col-sm-1" style="background-color:lavender;"><?php echo $vlRegistro['ID_Doctor']; ?></div>
					<input type="hidden" name="txtId" value=<?php echo $vlRegistro['ID_Doctor']; ?>>
					<div class="col-sm-2" style="background-color:lavenderblush;"><?php echo $vlRegistro['nombre']; ?></div>
					<div class="col-sm-2" style="background-color:lavender;"><?php echo $vlRegistro['apellido']; ?></div>
					<div class="col-sm-1" style="background-color:lavenderblush;"><?php echo $vlRegistro['telefono']; ?></div>
					<div class="col-sm-2" style="background-color:lavender;"><?php echo $vlRegistro['direccion']; ?></div>
					<div class="col-sm-2" style="background-color:lavenderblush;"><?php echo $vlRegistro['correo']; ?></div>	
